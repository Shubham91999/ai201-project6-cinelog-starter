...
**How I resolved it:**
I implemented the watchlist feature directly on the UUID model shape from main and kept all lookups and fixtures UUID-based so no integer-ID assumptions remained.

**How I verified no conflict remains:**
I ran the watchlist test suite against the current UUID-based models and confirmed the feature works with UUID film IDs throughout.
